    ...
    <aside class="admin-sidebar">
        ...
        <nav class="admin-nav">
            ...
            <a href="<?php echo URLROOT; ?>/admin/dashboard"
               class="<?php echo strpos($currentPath, '/admin/dashboard') !== false ? 'active' : ''; ?>">
               Dashboard
            </a>

            <a href="<?php echo URLROOT; ?>/admin/products"
               class="<?php echo strpos($currentPath, '/admin/products') !== false || strpos($currentPath, '/admin/add_product') !== false || strpos($currentPath, '/admin/edit_product') !== false ? 'active' : ''; ?>">
               Products
            </a>

            <a href="<?php echo URLROOT; ?>/admin/bookings"
               class="<?php echo strpos($currentPath, '/admin/bookings') !== false ? 'active' : ''; ?>">
               Bookings
            </a>

            <a href="<?php echo URLROOT; ?>/admin/orders"
               class="<?php echo strpos($currentPath, '/admin/orders') !== false ? 'active' : ''; ?>">
               Orders
            </a>

            <a href="<?php echo URLROOT; ?>/admin/messages"
               class="<?php echo strpos($currentPath, '/admin/messages') !== false ? 'active' : ''; ?>">
               Messages
            </a>
